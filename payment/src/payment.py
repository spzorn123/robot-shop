...
def K8_metrics():
    newrelic.agent.add_custom_parameter('nodeName', os.getenv('K8S_NODE_NAME'))
    newrelic.agent.add_custom_parameter('nodeIP', os.getenv('K8S_HOST_IP'))
    newrelic.agent.add_custom_parameter('podName', os.getenv('K8S_POD_NAME'))
    newrelic.agent.add_custom_parameter('podIP', os.getenv('K8S_POD_IP'))
    newrelic.agent.add_custom_parameter('namespace', os.getenv('K8S_POD_NAMESPACE'))
    newrelic.agent.add_custom_parameter('namespaceName', os.getenv('K8S_POD_NAMESPACE'))
...
def pay(id):
    ...
    newrelic.agent.add_custom_parameter('username', id)
